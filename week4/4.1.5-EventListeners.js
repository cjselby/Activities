...
document.querySelector("#dog-picture").addEventListener("click", () => alert("You clicked the dog pic"));
...
document.querySelector("#class-schedule-list").addEventListener("mouseover", (event) => event.target.style.backgroundColor = "green");
